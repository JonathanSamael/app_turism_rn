...
class _ListLocationsState extends State<ListLocations> {
      ...
      children: locations
          .map(
            (location) => GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            //definir o alinhamento do coração na linha
                            children: [
                              Text(
              ...
              onTap: () => {_onTapNavigator(location, location.id)},
            ),
          )
          .toList(),
    );
  ...
  _onTapNavigator(location, int locationID) {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => LocationDetais(location, id: locationID)));
  }
}
